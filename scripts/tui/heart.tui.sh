#!/usr/bin/env bash
# BLUX Lite — TUI wrapper for: scripts/cloud_backup_20250917T191923Z/heart.sh
...
ORIG="scripts/cloud_backup_20250917T191923Z/heart.sh"
ORIG_ABS="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)/scripts/cloud_backup_20250917T191923Z/heart.sh"
LOG_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)/logs"
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/$(basename "scripts/cloud_backup_20250917T191923Z/heart.sh").log"
...
menu() {
  while true; do
    clear
    echo "=== BLUX TUI: $(basename "scripts/cloud_backup_20250917T191923Z/heart.sh") ==="
